...
export async function paginatedNamespacedReplicaSetList(
  ...
  return await paginatedNamespacedList(
    namespace,
    v1ReplicaSetList,
    k8sApi.appsClient.listNamespacedReplicaSetWithHttpInfo.bind(k8sApi.appsClient),
  );
}
...
export async function paginatedClusterReplicaSetList(): Promise<V1ReplicaSetList> {
  ...
  return await paginatedClusterList(
    v1ReplicaSetList,
    k8sApi.appsClient.listReplicaSetForAllNamespacesWithHttpInfo.bind(k8sApi.appsClient),
  );
}
