...
test('isPodAssociatedWithParent', async () => {
  const mockPodWithoutMetadata = {};
  expect(metadataExtractor.isPodAssociatedWithParent(mockPodWithoutMetadata as V1Pod)).toEqual(false);
