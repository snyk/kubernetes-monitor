...
content = ''' Signed-off-by: Ivan Stanev istanev93@gmail.com
...
test_fail_info_comment = '''
Hello 👋

In case the tests fail, this is because there is a prerequisite to create a secret before deploying the Operator and the CustomResource that it manages:
[#1296 comment](https://github.com/operator-framework/community-operators/pull/1296#issuecomment-594567360)
'''
